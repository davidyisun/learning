...
if MODE == "PTB":             # PTB数据处理
    RAW_DATA = "D:/workspace_for_python/to_github/learning2/Data/PTB_data/ptb.train.txt"  # 训练集数据文件
    VOCAB_OUTPUT = "ptb.vocab"                         # 输出的词汇表文件
elif MODE == "TRANSLATE_ZH":  # 翻译语料的中文部分
    RAW_DATA = "D:/workspace_for_python/to_github/learning2/Data/TED_data/train.txt.zh"
    VOCAB_OUTPUT = "zh.vocab"
    VOCAB_SIZE = 4000
elif MODE == "TRANSLATE_EN":  # 翻译语料的英文部分
    RAW_DATA = "D:/workspace_for_python/to_github/learning2/Data/TED_data/train.txt.en"
